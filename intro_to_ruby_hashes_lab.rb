...
def monopoly_with_fourth_tier
  ...
  base[:railroads][:names][:pennsylvania_railroad] = {"mortgage_value": $5}
  base[:railroads][:names][:b_and_o_railroad] = {"mortgage_value": $5}
  base[:railroads][:names][:shortline_railroad] = {"mortgage_value": $5}
end
